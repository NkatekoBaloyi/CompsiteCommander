...
class MainActivity1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnViewItem = findViewById<Button>(R.id.btnViewItem)
        ...
        btnAddItem.setOnClickListener {
            ...
            if (item.isEmpty() || category.isEmpty() || quantityText.isEmpty() || comments.isEmpty()) {
                ...
                try {
                    ...
                    // Update display immediately when item is added
                    val totalItems = itemArray.size
                    val totalQuantity = quantityArray.sum()
